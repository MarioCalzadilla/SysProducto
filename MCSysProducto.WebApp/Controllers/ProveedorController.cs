...
namespace MCSysProducto.WebApp.Controllers
{
    public class ProveedorController : Controller
    {
        ...
        public async Task<ActionResult> DeleteProveedor(int id)
        {
            try
            {
                var result = await _proveedorBL.EliminararAsync(new Proveedor { Id = id });
        ...
        public async Task<ActionResult> ReporteProveedoresExcel()
        {
            ...
            using (var package = new ExcelPackage())
            {
                ...
                return File(stream, "application/vnd.openmxlformats-officedocument.spreadsheet.sheet", "ReporteProveedoresExcel.xlsx");
            }
        }

        public async Task<ActionResult> SubirExcelProveedor(IFormFile archivoExcel)
        {
