...
namespace MCSysProducto.WebApp.Controllers
{
    public class ProductoController : Controller
    {
        ...
        public async Task<ActionResult> Delete(Producto pProducto)
        {
            try
            {
                await _productoBL.EliminararAsync(new Producto { Id = pProducto.Id });
                return RedirectToAction(nameof(Index));
            }
            catch
            {
        ...
        public async Task<ActionResult> ReporteProductosExcel()
        {
            ...
            using (var package = new ExcelPackage())
            {
                ...
                return File(stream, "application/vnd.openmxlformats-officedocument.spreadsheet.sheet", "ReporteProductosExcel.xlsx");
            }
        }


        public async Task<ActionResult> SubirExcelProducto(IFormFile archivoExcel)
        {
